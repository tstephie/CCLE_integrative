...
write.csv(final_transform, "final_RPKM_transform.csv")
...
phos_final <- read.csv("RPKM_phos_final.csv")
nonphos_final <- read.csv("RPKM_nonphos_final.csv")
#MAKE FCS, RECOMBO
...
nonphos_final <- nonphos_final[,c(1,2,3,8,9)]
